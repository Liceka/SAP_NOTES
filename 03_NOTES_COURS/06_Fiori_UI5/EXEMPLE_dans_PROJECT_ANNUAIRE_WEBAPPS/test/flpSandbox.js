		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Annuaire",
									"targetURL": "#stmsappaelion19annuaire-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"stmsappaelion19annuaire-display": {
								"semanticObject": "stmsappaelion19annuaire",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=stms.app.aelion19.annuaire",
									"url": sap.ui.require.toUrl("stms/app/aelion19/annuaire")
								}
							}
						}
					}
